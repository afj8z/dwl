...
static const float rootcolor[] = COLOR(0x111012ff);
static const float bordercolor[] = COLOR(0x595466ff);
static const float focuscolor[] = COLOR(0xDBD0C6ff);
static const float urgentcolor[] = COLOR(0xC76B6Bff);
